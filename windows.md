...
Download and unzip the following file: [vagrant.zip](https://github.com/FirehoseProject/firehose-vagrant/blob/master/tools/vagrant.zip?raw=true) to your __Desktop__. Unzip the file onto your Desktop, so it creates a folder called `vagrant` on your Desktop.  This is where all your web development environment will live.
